...
<!--                            <img src="assets/images/flags/russia.jpg" alt="user-image" class="mr-1" height="12"> -->
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="<?= AdminAsset::img($this, '/images/users/avatar-2.jpg') ?>"
                             alt="Header Avatar">
...
<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            <div class="mb-2">
                <img src="<?= AdminAsset::img($this, '/images/layouts/layout-1.jpg') ?>" class="img-fluid img-thumbnail" alt="">
            </div>
            ...
            <div class="mb-2">
                <img src="<?= AdminAsset::img($this, '/images/layouts/layout-2.jpg') ?>" class="img-fluid img-thumbnail" alt="">
            </div>
            <div class="custom-control custom-switch mb-3">
            ...
            <div class="mb-2">
                <img src="<?= AdminAsset::img($this, '/images/layouts/layout-3.jpg') ?>" class="img-fluid img-thumbnail" alt="">
            </div>
